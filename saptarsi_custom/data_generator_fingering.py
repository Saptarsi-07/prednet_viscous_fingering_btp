...
train_data = frames[:SIZE_TRAIN_DATA+1]  # Split into training, validation, and test data 
valid_data = frames[SIZE_TRAIN_DATA+1:SIZE_TRAIN_VALID_DATA+1]
test_data = frames[SIZE_TRAIN_VALID_DATA+1:]
...
train_dict['clips'] = np.zeros(shape=(2, LENGTH, 2))
train_dict['input_raw_data'] = np.zeros(shape=(SIZE_TRAIN_DATA, N_CHANNELS, INPUT_HEIGHT, INPUT_WIDTH))
...
train_dict['dims'] = [[1, INPUT_HEIGHT, INPUT_WIDTH]] # [[1, INPUT_HEIGHT, INPUT_WIDTH]]
