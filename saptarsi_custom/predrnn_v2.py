...
from tsne import visualization
...
class RNN(nn.Module):
    ...
    def forward(self, frames_tensor, mask_true):
        ...
        frames = frames_tensor.permute()
        batch = frames.shape[0] # Will be 20 
        height = frames.shape[1] # Will be 128 
        width = frames.shape[2] # Will be 128 
